...
begin
    ...
    process is
    begin
        -- Test pattern: (A, B) | Operation | FaultLocation Always 1111
        -- Group 1: A + B (Operation=000)
        -- A=0, B=0 => A + B = 0
        A <= "0000"; B <= "0000"; Operation <= "000"; FaultLocation <= "1111";
        wait for 10 ps;

        -- A=0, B=1 => A + B = 1
        A <= "0000"; B <= "0001"; Operation <= "000"; FaultLocation <= "1111";
        wait for 10 ps;

        -- A=1, B=0 => A + B = 1
        A <= "0000"; B <= "0010"; Operation <= "000"; FaultLocation <= "1111";
        wait for 10ps;

        -- A=1, B=1 => A + B = 2
        A <= "0001"; B <= "0001"; Operation <= "000"; FaultLocation <= "1111";
        wait;
