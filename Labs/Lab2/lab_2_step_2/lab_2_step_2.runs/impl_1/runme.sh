...
HD_PWD='C:/Users/erik/IES_codebase/programming_reliable_systems/Labs/Lab2/lab_2_step_2/lab_2_step_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ArithLogic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ArithLogic.tcl -notrace
