...
HD_PWD='C:/Users/erik/IES_codebase/programming_reliable_systems/Labs/Lab3/lab3_step2/lab3_step2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_LFSR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source n_bit_LFSR.tcl
