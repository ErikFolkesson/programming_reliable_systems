...
HD_PWD='C:/Users/erik/IES_codebase/programming_reliable_systems/Labs/Lab3/lab3_step2/lab3_step2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_LFSR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source n_bit_LFSR.tcl -notrace
