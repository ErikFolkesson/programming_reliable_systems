...
HD_PWD='C:/Users/erik/IES_codebase/programming_reliable_systems/Labs/Lab3/lab3_step3/lab3_step3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleMuxLFSR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DoubleMuxLFSR.tcl -notrace
